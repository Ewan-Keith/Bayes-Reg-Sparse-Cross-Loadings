...
data_list <- dir("sim_study/sim_data/dense/N_1000/lat_no_corr/data_output", full.names = T)
...
saveRDS(stansim_out, "sim_study/simulations/sim_results/Gaussian_ind_1000_nocorr_output.rds")
