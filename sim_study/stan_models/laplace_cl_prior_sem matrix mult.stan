...
transformed parameters{
  ...
  for(int_rows in 1:N){
    ...
    CL[2, 1] ~ double_exponential(0, .1); CL[3, 1] ~ double_exponential(0, .1);
    CL[2, 2] ~ double_exponential(0, .1); CL[3, 2] ~ double_exponential(0, .1);
    CL[2, 3] ~ double_exponential(0, .1); CL[3, 3] ~ double_exponential(0, .1);
    CL[2, 4] ~ double_exponential(0, .1); CL[3, 4] ~ double_exponential(0, .1);
    CL[2, 5] ~ double_exponential(0, .1); CL[3, 5] ~ double_exponential(0, .1);
    CL[1, 6] ~ double_exponential(0, .1); CL[3, 6] ~ double_exponential(0, .1);
    CL[1, 7] ~ double_exponential(0, .1); CL[3, 7] ~ double_exponential(0, .1);
    CL[1, 8] ~ double_exponential(0, .1); CL[3, 8] ~ double_exponential(0, .1);
    CL[1, 9] ~ double_exponential(0, .1); CL[3, 9] ~ double_exponential(0, .1);
    CL[1, 10] ~ double_exponential(0, .1); CL[3, 10] ~ double_exponential(0, .1);
    CL[1, 11] ~ double_exponential(0, .1); CL[2, 11] ~ double_exponential(0, .1);
    CL[1, 12] ~ double_exponential(0, .1); CL[2, 12] ~ double_exponential(0, .1);
    CL[1, 13] ~ double_exponential(0, .1); CL[2, 13] ~ double_exponential(0, .1);
    CL[1, 14] ~ double_exponential(0, .1); CL[2, 14] ~ double_exponential(0, .1);
    CL[1, 15] ~ double_exponential(0, .1); CL[2, 15] ~ double_exponential(0, .1);
