...
model{
  ...
  ///////// specify cross loading matrix free estimates ///////
    // equivalent to CL[r, c] ~ double_exponential(0, .05)
  CL[2, 1]*20 ~ double_exponential(0, 1); CL[3, 1]*20 ~ double_exponential(0, 1);
  CL[2, 2]*20 ~ double_exponential(0, 1); CL[3, 2]*20 ~ double_exponential(0, 1);
  CL[2, 3]*20 ~ double_exponential(0, 1); CL[3, 3]*20 ~ double_exponential(0, 1);
  CL[2, 4]*20 ~ double_exponential(0, 1); CL[3, 4]*20 ~ double_exponential(0, 1);
  CL[2, 5]*20 ~ double_exponential(0, 1); CL[3, 5]*20 ~ double_exponential(0, 1);
  CL[1, 6]*20 ~ double_exponential(0, 1); CL[3, 6]*20 ~ double_exponential(0, 1);
  CL[1, 7]*20 ~ double_exponential(0, 1); CL[3, 7]*20 ~ double_exponential(0, 1);
  CL[1, 8]*20 ~ double_exponential(0, 1); CL[3, 8]*20 ~ double_exponential(0, 1);
  CL[1, 9]*20 ~ double_exponential(0, 1); CL[3, 9]*20 ~ double_exponential(0, 1);
  CL[1, 10]*20 ~ double_exponential(0, 1); CL[3, 10]*20 ~ double_exponential(0, 1);
  CL[1, 11]*20 ~ double_exponential(0, 1); CL[2, 11]*20 ~ double_exponential(0, 1);
  CL[1, 12]*20 ~ double_exponential(0, 1); CL[2, 12]*20 ~ double_exponential(0, 1);
  CL[1, 13]*20 ~ double_exponential(0, 1); CL[2, 13]*20 ~ double_exponential(0, 1);
  CL[1, 14]*20 ~ double_exponential(0, 1); CL[2, 14]*20 ~ double_exponential(0, 1);
  CL[1, 15]*20 ~ double_exponential(0, 1); CL[2, 15]*20 ~ double_exponential(0, 1);
